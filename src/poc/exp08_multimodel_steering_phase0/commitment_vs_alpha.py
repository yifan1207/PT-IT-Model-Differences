...
Usage:
  uv run python -m src.poc.exp08_multimodel_steering_phase0.commitment_vs_alpha --model-name llama31_8b
  uv run python -m src.poc.exp08_multimodel_steering_phase0.commitment_vs_alpha  # all models
"""
