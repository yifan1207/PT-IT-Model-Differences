...
Output:
  results/exp08_multimodel_steering_phase0/plots/data/phase0_direction_stability.json

Usage:
  uv run python -m src.poc.exp08_multimodel_steering_phase0.direction_stability
  # Or on Modal (with volume):
  python -m src.poc.exp08_multimodel_steering_phase0.direction_stability --base-dir /results
"""
...
def main():
    ...
    # Save
    out_dir = Path("results/exp08_multimodel_steering_phase0/plots/data")
