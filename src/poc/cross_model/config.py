...
MODEL_REGISTRY: dict[str, ModelSpec] = {
    ...
    "llama31_meta_instruct": ModelSpec(
        name="llama31_meta_instruct",
        pt_id="meta-llama/Llama-3.1-8B",
        it_id="meta-llama/Llama-3.1-8B-Instruct",
        n_layers=32,
        d_model=4096,
    ...
    "llama31_tulu3_sft": ModelSpec(
        name="llama31_tulu3_sft",
        pt_id="meta-llama/Llama-3.1-8B",
        it_id="allenai/Llama-3.1-Tulu-3-8B-SFT",
        n_layers=32,
        d_model=4096,
        n_heads=32,
        n_kv_heads=8,
        global_attn_layers=frozenset(range(32)),
        pt_revision="d04e592bb4f6aa9cfee91e2e20afa771667e1d4b",
        it_revision="f2a0b46b0cfda21003c6141b1ff837b7e165524d",
    ),
    "llama31_tulu3_dpo": ModelSpec(
        name="llama31_tulu3_dpo",
        pt_id="meta-llama/Llama-3.1-8B",
        it_id="allenai/Llama-3.1-Tulu-3-8B-DPO",
        n_layers=32,
        d_model=4096,
        n_heads=32,
        n_kv_heads=8,
        global_attn_layers=frozenset(range(32)),
        pt_revision="d04e592bb4f6aa9cfee91e2e20afa771667e1d4b",
        it_revision="a7beb67e33ffd01cc87ac3b46cadc1000985b8db",
    ),
    "llama31_tulu3_final": ModelSpec(
        name="llama31_tulu3_final",
        pt_id="meta-llama/Llama-3.1-8B",
        it_id="allenai/Llama-3.1-Tulu-3-8B",
        n_layers=32,
        d_model=4096,
        n_heads=32,
        n_kv_heads=8,
        global_attn_layers=frozenset(range(32)),
        pt_revision="d04e592bb4f6aa9cfee91e2e20afa771667e1d4b",
        it_revision="666943798adbde0b1aff34626007e26986a3c107",
    ),
    "llama31_openmath2": ModelSpec(
        name="llama31_openmath2",
        pt_id="meta-llama/Llama-3.1-8B",
        it_id="nvidia/OpenMath2-Llama3.1-8B",
        n_layers=32,
        d_model=4096,
        n_heads=32,
        n_kv_heads=8,
        global_attn_layers=frozenset(range(32)),
        pt_revision="d04e592bb4f6aa9cfee91e2e20afa771667e1d4b",
        it_revision="0f9db814ea4acd66485b9e6679b3e58df8663875",
    ),
    "llama31_hermes3": ModelSpec(
        name="llama31_hermes3",
        pt_id="meta-llama/Llama-3.1-8B",
        it_id="NousResearch/Hermes-3-Llama-3.1-8B",
        n_layers=32,
        d_model=4096,
        n_heads=32,
        n_kv_heads=8,
