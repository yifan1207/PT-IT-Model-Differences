...
Usage:
    uv run python -m src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.run_weight_shift           # 8 GPUs (default)
    uv run python -m src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.run_weight_shift --gpus 1  # single GPU
    uv run python -m src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.run_weight_shift --output results/my_dir
...
from src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.weight_shift import compute_weight_shift, print_summary
from src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot_weight_shift import make_plot
