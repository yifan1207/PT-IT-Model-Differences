...
from src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.collect import _entropy_from_logits
...
def test_collect_prompt_output_schema():
    ...
    from src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.collect import collect_prompt
    ...
    import contextlib
    from src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison import collect as collect_mod
...
@pytest.mark.parametrize("plot_module,plot_fn", [
    ("src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot1_l0_per_layer", "make_plot"),
    ("src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot2_l0_heatmap", "make_plot"),
    ("src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot4_layer_delta_norm", "make_plot"),
    ("src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot5_residual_norm", "make_plot"),
    ("src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot6_output_entropy", "make_plot"),
    ("src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot7_logit_lens_entropy", "make_plot"),
    ("src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot8_logit_lens_heatmap", "make_plot"),
    ("src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot9_generation_length", "make_plot"),
    ("src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot10_cosine_similarity", "make_plot"),
])
...
def test_plot3_gracefully_skips_without_npz(tmp_path):
    ...
    from src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot3_feature_overlap import make_plot
    results = _make_synthetic_results()
...
def test_run_plots_uses_npz_matching_results_filename(tmp_path, monkeypatch):
    ...
    from src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison import run_plots as run_plots_mod
...
@pytest.mark.parametrize("plot_module", [
    "src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot1_l0_per_layer",
    "src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot4_layer_delta_norm",
    "src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot5_residual_norm",
    "src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot7_logit_lens_entropy",
])
...
def test_plot10_missing_data_produces_nan_not_zero():
    ...
    from src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot10_cosine_similarity import _mean_cos_profile, _cosine
...
def test_plot10_uses_prompt_relative_thirds():
    ...
    from src.poc.exp02_ic_ooc_reasoning_mechanistic_comparison.plots.plot10_cosine_similarity import _split_into_thirds
