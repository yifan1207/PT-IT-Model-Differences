...
from src.poc.exp01_hierarchical_distributional_narrowing.analyze import build_result, run_regression, save_results, save_scatter_plot
...
def _gpu_worker(gpu_idx: int, prompt_items: list, cfg: PocConfig) -> list[dict]:
    ...
    import time
    from src.poc.shared.attribution import run_attribution
    from src.poc.exp01_hierarchical_distributional_narrowing.analyze import build_result
