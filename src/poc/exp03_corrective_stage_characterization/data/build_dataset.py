...
Usage
-----
  python -m src.poc.exp03_corrective_stage_characterization.data.build_dataset [--output PATH] [--seed N]
...
def _load_ooc() -> list[dict]:
    from src.poc.exp03_corrective_stage_characterization.data.ooc_prompts import all_ooc_prompts
    _TYPE_TO_QTYPE = {
...
def _load_a5a_harmful(n: int, rng: np.random.Generator) -> list[dict]:
    ...
    """
    from src.poc.exp03_corrective_stage_characterization.data.safety_prompts import A4A_HARMFUL
...
def _load_a5b_borderline(n: int, rng: np.random.Generator) -> list[dict]:
    ...
    """
    from src.poc.exp03_corrective_stage_characterization.data.safety_prompts import A4B_BORDERLINE
    hf_records: list[dict] = []
    try:
        from datasets import load_dataset
...
def _load_a5c_format(n: int, rng: np.random.Generator) -> list[dict]:
    ...
    from src.poc.exp03_corrective_stage_characterization.data.safety_prompts import A4C_FORMAT
    hf_records: list[dict] = []
    try:
        from datasets import load_dataset
...
def _load_a5d_conversational() -> list[dict]:
    ...
    from src.poc.exp03_corrective_stage_characterization.data.safety_prompts import A4D_MULTI_TURN, A4D_ROLEPLAY
    results = []
...
def _load_a5e_raw_completion(n: int, rng: np.random.Generator) -> list[dict]:
    ...
    """
    from src.poc.exp03_corrective_stage_characterization.data.safety_prompts import A4E_EXTRA_CONTINUATIONS
    candidates: list[str] = []
