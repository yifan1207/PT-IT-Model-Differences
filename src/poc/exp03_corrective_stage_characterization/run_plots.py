...
Usage:
    uv run python -m src.poc.exp03_corrective_stage_characterization.run_plots --variant it
    uv run python -m src.poc.exp03_corrective_stage_characterization.run_plots --results path/to/results.jsonl
    uv run python -m src.poc.exp03_corrective_stage_characterization.run_plots --variant it --pt-results path/to/pt_results.jsonl
    uv run python -m src.poc.exp03_corrective_stage_characterization.run_plots --variant it --weight-shift path/to/weight_shift.json
    uv run python -m src.poc.exp03_corrective_stage_characterization.run_plots --results results/it_run/results.jsonl \\
...
from src.poc.exp03_corrective_stage_characterization.plots.plot1_transcoder_error import make_plot as plot1
from src.poc.exp03_corrective_stage_characterization.plots.plot2_emergence import make_plot as plot2
from src.poc.exp03_corrective_stage_characterization.plots.plot3_attraction_repulsion import make_plot as plot3
from src.poc.exp03_corrective_stage_characterization.plots.plot4_token_stratification import make_plot as plot4
from src.poc.exp03_corrective_stage_characterization.plots.plot5_alignment_tax import make_plot as plot5
from src.poc.exp03_corrective_stage_characterization.plots.plot6_kl_trajectory import make_plot as plot6
from src.poc.exp03_corrective_stage_characterization.plots.plot7_ablation_comparison import make_plot as plot7
from src.poc.exp03_corrective_stage_characterization.plots.plot8_weight_norm import make_plot as plot8
from src.poc.exp03_corrective_stage_characterization.plots.plot9_precorrection import make_plot as plot9
from src.poc.exp03_corrective_stage_characterization.plots.plot10_generation_heatmap import make_plot as plot10
from src.poc.exp04_phase_transition_characterization.plots.plot1_jaccard_curve import make_plot as plot_jaccard
from src.poc.exp03_corrective_stage_characterization.plots.plot_feature_populations import make_plot as plot_feat_pop
from src.poc.exp03_corrective_stage_characterization.plots.plot_e3_3_raw_completion import make_plot as plot_e3_3
from src.poc.exp03_corrective_stage_characterization.plots.plot_e3_4_matched_token import make_plot as plot_e3_4
from src.poc.exp03_corrective_stage_characterization.plots.plot_e3_5_confidence_stratified import make_plot as plot_e3_5
from src.poc.exp03_corrective_stage_characterization.plots.plot_e3_9_step_stability import make_plot as plot_e3_9
from src.poc.exp03_corrective_stage_characterization.plots.plot_e3_10_mind_change import make_plot as plot_e3_10
from src.poc.exp03_corrective_stage_characterization.plots.plot_e3_11_feature_importance import make_plot as plot_e3_11
from src.poc.exp03_corrective_stage_characterization.plots.plot_e3_12_adjacent_layer_kl import make_plot as plot_e3_12
from src.poc.exp03_corrective_stage_characterization.plots.plot_e3_13_candidate_reshuffling import make_plot as plot_e3_13
