...
Usage:
  uv run python -m src.poc.exp7.onset_threshold_sensitivity --output-dir results/exp7/0J/
  uv run python -m src.poc.exp7.onset_threshold_sensitivity --csv-path <custom_path>
"""
