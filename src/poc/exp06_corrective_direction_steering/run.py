...
# Ensure project root is on sys.path when run as a script (src/poc/exp06_corrective_direction_steering/run.py → ../../..)
...
from src.poc.exp06_corrective_direction_steering.benchmarks.governance import evaluate_governance_benchmark
...
from src.poc.exp06_corrective_direction_steering.config import Exp6Config
from src.poc.exp06_corrective_direction_steering.interventions import build_intervention
from src.poc.exp06_corrective_direction_steering.runtime import GeneratedSample6, generate_record_A, generate_record_B, generate_records_A_batch, generate_records_B_batch
...
def _score_benchmark(
    ...
    from src.poc.exp05_corrective_direction_ablation_cartography.runtime import GeneratedSample as GS5
    adapted = [GS5(
