...
from src.poc.exp06_corrective_direction_steering.interventions import Exp6InterventionSpec
...
def _make_wdec_inject_hooks(
    ...
    """
    from src.poc.exp06_corrective_direction_steering.interventions import directional_inject_tensor
    handles = []
