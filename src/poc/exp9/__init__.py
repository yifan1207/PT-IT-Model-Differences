...
Modal scripts for tuned-lens (0G):
  scripts/modal_train_0G.py             Probe training (12 jobs: 6 models x 2 variants)
  scripts/modal_eval_0G.py              Commitment evaluation
...
Results:
  ...
  results/exp9/plots/                      PNG figures
  results/exp9/data/                       JSON exports for paper
...
Quick start:
  ...
  modal run scripts/modal_train_0G.py

  # Generate plots:
  uv run python -m src.poc.exp9.plot_replication
  uv run python -m src.poc.exp9.plot_commitment
"""
