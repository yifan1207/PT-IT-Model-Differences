...
CLI:
    python src/poc/exp6/precompute.py --task aggregate-content-direction
    python src/poc/exp6/precompute.py --task mean-feature-acts --device cuda:7
    python src/poc/exp6/precompute.py --task governance-direction
"""
