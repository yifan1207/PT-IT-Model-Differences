...
def smoke_test() -> str:
    ...
    scripts = [
        ...
        "/root/src/poc/exp08_multimodel_steering_phase0/pca_rank1.py",
        "/root/src/poc/exp08_multimodel_steering_phase0/id_under_steering.py",
        "/root/src/poc/exp08_multimodel_steering_phase0/commitment_vs_alpha.py",
