...
Usage:
    ...
    uv run python scripts/plot_validation_tier0.py --experiments 0A 0B 0D
"""
...
def _compute_0H_ci(
    ...
    """
    from src.poc.exp07_methodology_validation_tier0.bootstrap_ci import rescore_per_record, _bootstrap_ci_bca
...
def plot_0H_calibration_split(output_dir: Path = PLOTS_DIR) -> None:
    ...
    from src.poc.exp07_methodology_validation_tier0.bootstrap_ci import load_dataset
...
def plot_0J_onset_sensitivity(output_dir: Path = PLOTS_DIR) -> None:
    ...
    from src.poc.exp07_methodology_validation_tier0.onset_threshold_sensitivity import (
