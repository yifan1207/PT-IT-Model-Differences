...
USER_RANDOM_SEEDS="${RANDOM_SEEDS:-}"
USER_K_LIST="${K_LIST:-}"
...
case "$MODE" in
  smoke)
    ...
    K_LIST="${USER_K_LIST:-20}"
    RANDOM_SEEDS="${USER_RANDOM_SEEDS:-0}"
    WINDOWS="${USER_WINDOWS:-mid terminal_entry}"
    DIRECTIONS="${USER_DIRECTIONS:-rescue}"
    N_BOOT="${N_BOOT:-100}"
    N_PERM="${N_PERM:-100}"
    ;;
  pilot)
    ...
    K_LIST="${USER_K_LIST:-20 50 100 200}"
    RANDOM_SEEDS="${USER_RANDOM_SEEDS:-0 1 2}"
    WINDOWS="${USER_WINDOWS:-early mid late_preterminal midlate_preterminal terminal_entry}"
    DIRECTIONS="${USER_DIRECTIONS:-rescue degrade}"
    ;;
  full)
