...
#
# Results written to: results/exp02_ic_ooc_reasoning_mechanistic_comparison/it_*_notmpl/
# Then generates side-by-side comparison plots (plot10 and plot11) in:
#   results/exp02_ic_ooc_reasoning_mechanistic_comparison/plots_notmpl_comparison/
#
# Usage:
...
TMPL_RESULTS="results/exp02_ic_ooc_reasoning_mechanistic_comparison/it_16k_l0_big_affine_t512/exp2_results.json"
...
echo "[$(date +%T)] Done."
echo "  results/exp02_ic_ooc_reasoning_mechanistic_comparison/it_*_notmpl/"
echo "  results/exp02_ic_ooc_reasoning_mechanistic_comparison/plots_notmpl_comparison/"
