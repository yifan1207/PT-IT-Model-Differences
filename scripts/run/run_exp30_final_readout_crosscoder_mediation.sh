...
K_ANNEAL_START="${K_ANNEAL_START:-1000}"
K_ANNEAL_STEPS="${K_ANNEAL_STEPS:-5000}"
...
PILOT_CONFIGS="${PILOT_CONFIGS:-l31_d65536_k64,31,65536,64,20000,8192,512,0;l31_d65536_k128,31,65536,128,20000,8192,512,1;l31_d131072_k64,31,131072,64,24000,4096,1024,2}"
INCLUDE_K32="${INCLUDE_K32:-0}"
SELECTED_NAME="${SELECTED_NAME:-d65536_k64}"
SELECTED_DICT_SIZE="${SELECTED_DICT_SIZE:-65536}"
SELECTED_K="${SELECTED_K:-64}"
SELECTED_STEPS="${SELECTED_STEPS:-24000}"
SELECTED_BATCH_TOKENS="${SELECTED_BATCH_TOKENS:-8192}"
SELECTED_AUXK="${SELECTED_AUXK:-512}"
