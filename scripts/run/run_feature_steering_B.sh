...
for i in 0 1 2 3 4 5 6 7; do
    PYTHONPATH=$PYTHONPATH uv run python src/poc/exp06_corrective_direction_steering/run.py \
        --experiment B1 \
        --variant it \
        --device "cuda:$i" \
...
PYTHONPATH=$PYTHONPATH uv run python scripts/merge_steering_workers.py \
