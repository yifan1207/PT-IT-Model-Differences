...
CLAIMS = [
    ...
    Claim("Exp22 fixed-history native paired raw late KL", 1.354305668, exp22_fixed_history("it_native_native_fixed_raw_late_kl")),
    Claim("Exp22 fixed-history native paired raw late KL CI low", 1.334274571, exp22_fixed_history("it_native_native_fixed_raw_late_kl", "ci95_low")),
    Claim("Exp22 fixed-history native paired raw late KL CI high", 1.389715183, exp22_fixed_history("it_native_native_fixed_raw_late_kl", "ci95_high")),
    Claim("Exp22 fixed-history raw paired raw late KL", 0.655945011, exp22_fixed_history("it_native_raw_fixed_raw_late_kl")),
    Claim("Exp22 fixed-history raw paired raw late KL CI low", 0.631936461, exp22_fixed_history("it_native_raw_fixed_raw_late_kl", "ci95_low")),
    Claim("Exp22 fixed-history raw paired raw late KL CI high", 0.670186354, exp22_fixed_history("it_native_raw_fixed_raw_late_kl", "ci95_high")),
    Claim("Exp22 fixed-history template-delta paired raw late KL", 0.698360657, exp22_fixed_history("it_native_template_delta_raw_late_kl")),
    Claim("Exp22 fixed-history template-delta paired raw late KL CI low", 0.693097261, exp22_fixed_history("it_native_template_delta_raw_late_kl", "ci95_low")),
    Claim("Exp22 fixed-history template-delta paired raw late KL CI high", 0.730321369, exp22_fixed_history("it_native_template_delta_raw_late_kl", "ci95_high")),
    Claim("Exp22 fixed-history native CEM raw late KL", 0.754291009, exp22_fixed_history("it_native_native_fixed_cem_raw_late_kl")),
    Claim("Exp22 fixed-history native CEM raw late KL CI low", 0.702415084, exp22_fixed_history("it_native_native_fixed_cem_raw_late_kl", "ci95_low")),
    Claim("Exp22 fixed-history native CEM raw late KL CI high", 0.805835644, exp22_fixed_history("it_native_native_fixed_cem_raw_late_kl", "ci95_high")),
    Claim("Exp22 fixed-history raw CEM raw late KL", 0.245945696, exp22_fixed_history("it_native_raw_fixed_cem_raw_late_kl")),
    Claim("Exp22 fixed-history raw CEM raw late KL CI low", 0.201902480, exp22_fixed_history("it_native_raw_fixed_cem_raw_late_kl", "ci95_low")),
    Claim("Exp22 fixed-history raw CEM raw late KL CI high", 0.289208743, exp22_fixed_history("it_native_raw_fixed_cem_raw_late_kl", "ci95_high")),
    Claim("Exp22 fixed-history template-delta CEM raw late KL", 0.338213048, exp22_fixed_history("it_native_template_delta_cem_raw_late_kl")),
    Claim("Exp22 fixed-history template-delta CEM raw late KL CI low", 0.284252365, exp22_fixed_history("it_native_template_delta_cem_raw_late_kl", "ci95_low")),
    Claim("Exp22 fixed-history template-delta CEM raw late KL CI high", 0.393701149, exp22_fixed_history("it_native_template_delta_cem_raw_late_kl", "ci95_high")),
    Claim("Exp22 fixed-history min CEM retention", 0.797347561, exp22_fixed_history_quality("min_retained_fraction")),
